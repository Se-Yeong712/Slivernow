...
public class ArmAllExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arm_all_exercise);
        ...
        mediaPlayer = MediaPlayer.create(ArmAllExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
        ...
        b_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ArmAllExerciseActivity.this, ArmActivity.class);
        ...
        Glide.with(this).load(R.raw.arm_all).into(gif);
