...
public class ArmShoulderExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arm_shoulder_exercise);
        ...
        mediaPlayer = MediaPlayer.create(ArmShoulderExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
        ...
        b_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ArmShoulderExerciseActivity.this, LegActivity.class);
        ...
        Glide.with(this).load(R.raw.arm_shoulder).into(gif);
//        gif.setBackground(new ShapeDrawable(new OvalShape()));
