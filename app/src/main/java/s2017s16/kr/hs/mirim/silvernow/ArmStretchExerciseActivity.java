...
public class ArmStretchExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arm_stretch_exercise);
        ...
        mediaPlayer = MediaPlayer.create(ArmStretchExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
        ...
        b_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ArmStretchExerciseActivity.this, LegActivity.class);
        ...
        Glide.with(this).load(R.raw.arm_stretch).into(gif);
