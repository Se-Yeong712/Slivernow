...
class GymLegAdapter(val context: Context, private val dataList: ArrayList<GymDataModel>, val itemClick: (GymDataModel) -> Unit)
    : RecyclerView.Adapter<GymLegAdapter.ViewHolder>() {
