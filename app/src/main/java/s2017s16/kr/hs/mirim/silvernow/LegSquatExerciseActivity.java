...
public class LegSquatExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leg_squat_exercise);
        ...
        mediaPlayer = MediaPlayer.create(LegSquatExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
        ...
        b_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LegSquatExerciseActivity.this, LegActivity.class);
        ...
        Glide.with(this).load(R.raw.leg_squat).into(gif);
