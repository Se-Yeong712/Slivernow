...
public class LegStretchExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leg_stretch_exercise);
        ...
        mediaPlayer = MediaPlayer.create(LegStretchExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
        ...
        b_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LegStretchExerciseActivity.this, LegActivity.class);
        ...
        Glide.with(this).load(R.raw.leg_stretch).into(gif);
