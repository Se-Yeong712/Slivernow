...
public class WaistExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_waist_exercise);
        ...
        mediaPlayer = MediaPlayer.create(WaistExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
        ...
        b_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WaistExerciseActivity.this, LegActivity.class);
        ...
        Glide.with(this).load(R.raw.waist).into(gif);
