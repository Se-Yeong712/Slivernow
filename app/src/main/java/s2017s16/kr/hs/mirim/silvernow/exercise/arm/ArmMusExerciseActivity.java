...
public class ArmMusExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arm_mus_exercise);
...
//        actionbar.setDisplayHomeAsUpEnabled(true);
        ...
        mediaPlayer = MediaPlayer.create(ArmMusExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
...
/*                Intent intent = new Intent(EyeExerciseActivity.this,EyeActivity.class);
                ...
                ArmMusExerciseActivity eyeExe = new ArmMusExerciseActivity();
                eyeExe.finish();
        ...
        Glide.with(this).load(R.raw.armmus).into(gif);
...
//                                    }
                ...
                Intent intent = new Intent(ArmMusExerciseActivity.this, PopupActivity.class);
