package s2017s16.kr.hs.mirim.silvernow.exercise.arm;
...
public class ArmShouExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arm_shou_exercise);
        ...
        mediaPlayer = MediaPlayer.create(ArmShouExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
...
/*                Intent intent = new Intent(EyeExerciseActivity.this,EyeActivity.class);
                ...
                ArmShouExerciseActivity eyeExe = new ArmShouExerciseActivity();
                eyeExe.finish();
        ...
        Glide.with(this).load(R.raw.armshou).into(gif);
...
//                                    }
                ...
                Intent intent = new Intent(ArmShouExerciseActivity.this, PopupActivity.class);
