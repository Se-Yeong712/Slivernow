...
public class BodyPlankExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_plank_exercise);
        ...
        mediaPlayer = MediaPlayer.create(BodyPlankExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
...
/*                Intent intent = new Intent(EyeExerciseActivity.this,EyeActivity.class);
                ...
                BodyPlankExerciseActivity eyeExe = new BodyPlankExerciseActivity();
                eyeExe.finish();
...
//                                    }
                ...
                Intent intent = new Intent(BodyPlankExerciseActivity.this, PopupActivity.class);
