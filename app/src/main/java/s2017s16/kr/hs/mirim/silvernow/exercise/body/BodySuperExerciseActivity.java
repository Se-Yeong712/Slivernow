...
public class BodySuperExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_super_exercise);
        ...
        mediaPlayer = MediaPlayer.create(BodySuperExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
...
/*                Intent intent = new Intent(EyeExerciseActivity.this,EyeActivity.class);
                ...
                BodySuperExerciseActivity eyeExe = new BodySuperExerciseActivity();
                eyeExe.finish();
        ...
        Glide.with(this).load(R.raw.bodysuper).into(gif);
...
//                                    }
                ...
                Intent intent = new Intent(BodySuperExerciseActivity.this, PopupActivity.class);
