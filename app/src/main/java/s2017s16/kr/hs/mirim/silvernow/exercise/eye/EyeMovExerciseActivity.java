...
public class EyeMovExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eye_mov_exercise);
        ...
        mediaPlayer = MediaPlayer.create(EyeMovExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
...
/*                Intent intent = new Intent(EyeExerciseActivity.this,EyeActivity.class);
                ...
                EyeMovExerciseActivity eyeExe = new EyeMovExerciseActivity();
                eyeExe.finish();
        ...
        Glide.with(this).load(R.raw.eyemov).into(gif);
...
//                                    }
                ...
                Intent intent = new Intent(EyeMovExerciseActivity.this, PopupActivity.class);
