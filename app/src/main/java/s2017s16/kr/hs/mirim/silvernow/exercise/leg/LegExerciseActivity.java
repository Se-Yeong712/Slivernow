...
/*                Intent intent = new Intent(EyeExerciseActivity.this,EyeActivity.class);
                ...
                LegExerciseActivity eyeExe = new LegExerciseActivity();
                eyeExe.finish();
        ...
        Glide.with(this).load(R.raw.leggif).into(gif);
...
/*                LegExerciseActivity eyeExe = new LegExerciseActivity();
                ...
                Intent intent = new Intent(LegExerciseActivity.this, PopupActivity.class);
