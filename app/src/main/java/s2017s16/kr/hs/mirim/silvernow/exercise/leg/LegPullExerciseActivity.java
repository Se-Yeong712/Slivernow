...
public class LegPullExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leg_pull_exercise);
        ...
        mediaPlayer = MediaPlayer.create(LegPullExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
...
/*                Intent intent = new Intent(EyeExerciseActivity.this,EyeActivity.class);
                ...
                LegPullExerciseActivity eyeExe = new LegPullExerciseActivity();
                eyeExe.finish();
        ...
        Glide.with(this).load(R.raw.legpull).into(gif);
...
//                                    }
                ...
                Intent intent = new Intent(LegPullExerciseActivity.this, PopupActivity.class);
