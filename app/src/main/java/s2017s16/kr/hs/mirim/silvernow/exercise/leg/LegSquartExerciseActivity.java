package s2017s16.kr.hs.mirim.silvernow.exercise.leg;
...
public class LegSquartExerciseActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button b_stop;
    Button b_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leg_squart_exercise);
...
//        actionbar.setDisplayHomeAsUpEnabled(true);
        ...
        mediaPlayer = MediaPlayer.create(LegSquartExerciseActivity.this, R.raw.music);
        mediaPlayer.start();
...
/*                Intent intent = new Intent(EyeExerciseActivity.this,EyeActivity.class);
                ...
                LegSquartExerciseActivity eyeExe = new LegSquartExerciseActivity();
                eyeExe.finish();
        ...
        Glide.with(this).load(R.raw.legsquart).into(gif);
...
//                                    }
                ...
                Intent intent = new Intent(LegSquartExerciseActivity.this, PopupActivity.class);
