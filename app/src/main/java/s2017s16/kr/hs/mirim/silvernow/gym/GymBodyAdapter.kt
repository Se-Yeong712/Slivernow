...
class GymBodyAdapter(val context: Context, private val dataList: ArrayList<GymDataModel>, val itemClick: (GymDataModel) -> Unit)
    : RecyclerView.Adapter<GymBodyAdapter.ViewHolder>() {
